 ...
 app.initMap = function() {
 	...
 	let map;
	    ...
	    let sunriseLocations = [
	    	...
	    	{locnum: "locnum12", name: "<h2 class='infobox-h2-1'>Sunrise Records</h2><h2 class='infobox-h2-2'>White Oaks Mall</h2> <p class='infobox-p-1'>1105 Wellington Rd<br/>London, ON. N6E 1V4</p><p class='infobox-p-2'>519-649-4493</p>", srLat: 42.931439, srLng: -81.223870},  	     
	      	...
	      	//{locnum: "locnum2", name: "<h2 class='infobox-h2-1'>Sunrise Records</h2><h2 class='infobox-h2-2'>CF Fairview Mall</h2> <p class='infobox-p-1'>1800 Sheppard Ave E<br/>Toronto, ON. M2J 5A7</p><p class='infobox-p-2'>416-494-9563</p>", srLat: 43.778119, srLng: -79.343087},
			...
			{locnum: "locnum29", name: "<h2 class='infobox-h2-1'>Sunrise Records</h2><h2 class='infobox-h2-2'>Metropolis at Metrotown</h2> <p class='infobox-p-1'>4700 Kingsway<br/>Burnaby, BC V5H 4M1</p><p class='infobox-p-2'>604-438-6576</p>", srLat: 49.227476, srLng: -122.999826},
	      	...
	      	{locnum: "locnum32", name: "<h2 class='infobox-h2-1'>Sunrise Records</h2><h2 class='infobox-h2-2'>Willowbrook Shopping Centre</h2> <p class='infobox-p-1'>19705 Fraser Highway<br/>Langley, BC V3A 7E9</p><p class='infobox-p-2'>604-510-0477</p>", srLat: 49.880007, srLng: -119.440986},
    ...
    },
    {
        ...
        for (i = 0; i < locationsQuantity; i++) {
	        ...
	        position: {lat: sunriseLocations[i].srLat, lng: sunriseLocations[i].srLng},
       	    icon: sunriseIcon, 
    	    map: map,
        	draggable: false,
          	animation: google.maps.Animation.DROP,
	        ...
	        let storeName = sunriseLocations[i].name;
		...
		//add listeners to each locnum div and then find matching object in locations array
		for (i=0; i < locationsQuantity; i++){
